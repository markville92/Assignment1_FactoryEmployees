...
namespace FactoryEmployees
{
    class ShiftSupervisor : Employee
    {
        ...
        private int shift;
        private double anProductionBonus;

        public ShiftSupervisor()
        {
            annual_salary = 0.0;
            shift = 0;
            anProductionBonus = 0.0;
        }
        ...
        : base(_empName, _empID, _hireDate)
        {
            ...
            shift = _shift;
            anProductionBonus = annual_productionBonus;
        }
        ...
        public double AnProductionBonus
        {
            get
            {
                return anProductionBonus;
            }

            set
            {
                anProductionBonus = value;
            }
        }
        public override void DisplayStats()
        {
            ...
            Console.WriteLine("Annual Production Bonus: {0:C}", anProductionBonus);
